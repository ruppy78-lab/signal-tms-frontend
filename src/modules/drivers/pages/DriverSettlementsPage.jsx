...
import DriverFormSettlements from '../components/form/DriverFormSettlements';
    ...
    <div>
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <div className="page-title">{driver.first_name} {driver.last_name} — Settlements</div>
      ...
      <div className="card">
        <div className="card-body">
          <DriverFormSettlements driverId={id} />
        </div>
      </div>
    </div>
  );
