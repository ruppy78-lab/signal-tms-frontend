...
import DriverFormTrips from '../components/form/DriverFormTrips';
    ...
    <div>
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <div className="page-title">{driver.first_name} {driver.last_name} — Trip History</div>
